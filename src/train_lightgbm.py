...
# SAVE MODEL
# ==============================
joblib.dump(model, os.path.join(MODELS_DIR, "lightgbm_final.pkl"))
...
plt.savefig(os.path.join(FIGURES_DIR, "lgbm_confusion_matrix.png"))
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(FIGURES_DIR, "lgbm_feature_importance.png"))
plt.close()
...
results_path = os.path.join(BASE_DIR, "results", "lgbm_predictions.csv")
